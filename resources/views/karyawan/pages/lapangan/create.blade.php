...
@section('content')
    <h3><i class="fa fa-angle-right"></i> Tambah Lapangan Baru</h3>
    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel">
                ...
                @endif
                <form class="form-horizontal style-form" method="post" action="{{ route('karyawan.lapangans.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Nama lapangan</label>
                        <div class="col-sm-10">
                            <input name="nama_lapangan" type="text" value="{{ old('nama_lapangan') }}" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="harga_reguler" type="text" value="{{ old('harga_reguler') }}" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="harga_turnamen" type="text" value="{{ old('harga_turnamen') }}" class="form-control">
